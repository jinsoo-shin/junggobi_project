...
search.find_element_by_class_name("sc-eNQAEJ").send_keys("갤럭시s")
...
for data in url_list:
    url = "https://m.bunjang.co.kr/products/"+data+"?ref=검색결과&q=갤럭시s"
    driver.get(url)
    try:
        ...
        if len(sell)==0:
            ...
            size = ""
            title_list = ["삽니다", "급매", "매입", "주의사항", "노트", "급전", "구매"]
            start_check = True
